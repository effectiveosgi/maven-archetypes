...
As the archetypes are not yet released into Maven Central, it is necessary to clone from GitHub and install into your local Maven repository before use:

    git clone https://github.com/njbartlett/eosgi-maven.git
    cd eosgi-maven
    mvn install
